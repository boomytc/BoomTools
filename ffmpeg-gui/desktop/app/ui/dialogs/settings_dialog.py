...
class SettingsDialog(QDialog):
    ...
    def __init__(self, parent=None) -> None:
        ...
        health_panel = QFrame()
        health_panel.setObjectName("settingsHealthPanel")
        health_panel.setProperty("role", "panelSurface")
        health_layout = QHBoxLayout(health_panel)
        health_layout.setContentsMargins(12, 10, 12, 10)
        health_layout.setSpacing(10)
        health_title = QLabel("FFmpeg 环境")
        ...
        health_layout.addWidget(self.version_label, 1)
